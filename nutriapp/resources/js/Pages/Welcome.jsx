    ...
    return (
        <>
            ...
            <div className="min-h-screen bg-beige-100 dark:bg-dark-bg transition-colors duration-300">
                ...
                <section className="hero" style={{ backgroundImage: `linear-gradient(rgba(0, 0, 0, 0.5), rgba(0, 0, 0, 0.5)), url('${HERO_BG}')` }}>
                    <div className="hero-content">
                        <AnimatedElement animation="fade-in">
                            ...
                            <p className="text-xl mb-8 text-beige-100 dark:text-dark-text">
                ...
                {/* Stats Section */}
                <section className="section bg-beige-100 dark:bg-dark-bg">
                ...
                {/* Features Section */}
                <section id="servicos" className="section bg-white dark:bg-dark-bg">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                            <AnimatedElement animation="slide-in-left" delay={200}>
                                <div className="feature-card">
                                    <div className="h-16 w-16 bg-primary-50 dark:bg-dark-card rounded-full flex items-center justify-center mb-4">
                                        <svg className="w-8 h-8 text-primary dark:text-dark-primary" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                <section className="parallax h-[400px]" style={{ backgroundImage: `url('${PARALLAX_BG}')` }}>
                    <div className="parallax-overlay flex items-center justify-center">
                        <div className="text-center text-white dark:text-dark-text">
                            <AnimatedElement>
